# Cms: Display Modes Core Module

> This package is the authoritative, provider-neutral implementation of Display Modes. It owns domain behavior and data; optional API, Filament, Livewire, React, Vue, and Nuxt packages translate its public contracts for their surfaces.
...
[![Latest release](https://img.shields.io/github/v/release/liberusoftware/module-cms-display-modes?sort=semver)](https://github.com/liberusoftware/module-cms-display-modes/releases/latest) [![Tests](https://github.com/liberusoftware/module-cms-display-modes/actions/workflows/tests.yml/badge.svg?branch=main)](https://github.com/liberusoftware/module-cms-display-modes/actions/workflows/tests.yml)
...
```bash
composer require liberusoftware/module-cms-display-modes
```
...
<a href="https://github.com/liberusoftware/module-cms-display-modes/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=liberusoftware/module-cms-display-modes" alt="Contributors to liberusoftware/module-cms-display-modes">
</a>

[View the full contributors graph](https://github.com/liberusoftware/module-cms-display-modes/graphs/contributors).
